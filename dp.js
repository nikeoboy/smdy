var system = {win: false,mac: false,xll: false};var p = navigator.platform;var us = navigator.userAgent.toLowerCase();system.win = p.indexOf("Win") == 0;system.mac = p.indexOf("Mac") == 0;system.x11 = (p == "X11") || (p.indexOf("Linux") == 0);if(system.win || system.mac || system.xll) {}else{
var fc_fw="100%";  //广告宽度,单位px,如自适应宽度就改为100%;
var fc_fh="100px";    //广告高度,单位px
var fc_fsrc=['https://ae01.alicdn.com/kf/HTB1kdAfi_Zmx1VjSZFGq6yx2XXa9.jpg','https://ae01.alicdn.com/kf/HTB19k3JQgHqK1RjSZFPq6AwapXaF.jpg'];//图片地址[个数要和链接个数对应]
var fc_fl=['https://www.csdn.net/','https://www.csdn.net/'];//图片链接地址[个数要和图片地址个数对应]
